...
function clearProvisionalStreamForToolCall(){
 ...
 const note=String(streamText||streamDisplayText||"").replace(/\s+/g," ").trim();if(note)pushRunActivity("assistant_progress","تم",note.slice(0,300),"ملاحظة أثناء التنفيذ");
